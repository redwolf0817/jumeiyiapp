 ...
 * 默认 "列" 间距
 */
static CGFloat const JKDefaultColumnMargin = 5;
/**
 * 默认 "边" 间距
 */
static UIEdgeInsets const JKDefaultInsets  = {5,5,5,5};

@interface MyPointsViewLayout()
...
@implementation MyPointsViewLayout
...
- (UICollectionViewLayoutAttributes *)layoutAttributesForItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    //CGFloat height= 50+ arc4random_uniform(200);
         ...
         CGFloat height= [[self.collectionhight objectAtIndex:indexPath.item] integerValue] + 45;//每个单元格文字内容的整个高度,160+20图片和姓名高度和
