...
@interface DetailsOfTheProject2 ()

@end

@implementation DetailsOfTheProject2
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (tableView.tag == 211) {
        ...
        // NSLog(@"bty.Name %@ == bty.EnumName %@",per.Name,per.EnumName);
