 ...
 * 默认 "行" 间距
 */
static CGFloat const JKDefaultRowMargin    = 0.5;
/**
 * 默认 "列" 间距
 */
...
@implementation gerenzujiViewLayout
...
- (UICollectionViewLayoutAttributes *)layoutAttributesForItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    CGFloat height= [[self.hightarray objectAtIndex:indexPath.item] floatValue] + 30;//每个单元格文字内容的整个高度,160+20图片和姓名高度和
