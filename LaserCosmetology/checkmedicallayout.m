...
@implementation checkmedicallayout
...
- (UICollectionViewLayoutAttributes *)layoutAttributesForItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    CGFloat height= [[self.hightarray objectAtIndex:indexPath.item] floatValue] + 300;//每个单元格文字内容的整个高度,160+20图片和姓名高度和
