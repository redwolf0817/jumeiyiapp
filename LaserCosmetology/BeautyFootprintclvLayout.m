 ...
 * 默认的 “列数”
 */
static NSUInteger const JKDefaultColumns   = 2;
/**
 * 默认 "行" 间距
 */
static CGFloat const JKDefaultRowMargin    = 5.0;
/**
 * 默认 "列" 间距
 */
...
@interface BeautyFootprintclvLayout()
/**
...
@implementation BeautyFootprintclvLayout
...
- (UICollectionViewLayoutAttributes *)layoutAttributesForItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    CGFloat height= [[self.hightarray objectAtIndex:indexPath.item] floatValue] + 190;//每个单元格文字内容的整个高度,160+20图片和姓名高度和
